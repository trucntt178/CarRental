...
public class UpdateQuantityServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String updateCarId = request.getParameter("carId");
        String updateQuantity = request.getParameter("carQuantity");

        String url = "viewCartPage";
        boolean foundErr = false;
        try {
            int upQuantity = Integer.parseInt(updateQuantity);
                        ...
                        if (rentalDate == null) {
                            for (Map.Entry<TblCarDTO, Integer> carEntry : car.entrySet()) {
                                ...
                                if (dto != null) {
                                    ...
                                    if (carId.equals(updateCarId)) {
                                        carQuantity = upQuantity;
                                        carEntry.setValue(upQuantity);
                                    }
            ...
            log("UpdateQuantityServlet_Number " + ex.getMessage());
        } finally {
            if (!foundErr) {
