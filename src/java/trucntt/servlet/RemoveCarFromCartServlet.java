...
public class RemoveCarFromCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String removeCarId = request.getParameter("carId");
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    TblCarDTO carDto = new TblCarDTO();
                    carDto.setCarID(removeCarId);
                    cart.removeCarFromCart(carDto);
            ...
            log("RemoveCarFromCartServlet_SQL " + ex.getMessage());
        } catch (NamingException ex) {
            log("RemoveCarFromCartServlet_Naming " + ex.getMessage());
        } finally {
            if (!foundErr) {
