...
import trucntt.tbldiscount.TblDiscountDAO;
 ...
 * @author DELL
 */
@WebServlet(name = "UseDiscountServlet", urlPatterns = {"/UseDiscountServlet"})
public class UseDiscountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float value = discountDao.getDiscountValue(discountId, new Date());
            if (value > 0) {
                TblDiscountDTO discountDto = new TblDiscountDTO(discountId, value);
                ...
                foundErr = true;
                request.setAttribute("DISCOUNTERR", "This code is unavailable");
            }
            if (foundErr) {
            ...
            log("UseDiscountServlet_Naming " + ex.getMessage());
        } catch (SQLException ex) {
            log("UseDiscountServlet_SQL " + ex.getMessage());
        } finally {
            if (!foundErr) {
